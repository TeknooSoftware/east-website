...
/**
 * Object writer in charge of object `Teknoo\East\Website\Object\Comment`.
 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements WriterInterface<Comment>
 */
class CommentWriter implements WriterInterface
{
    /**
     * @use PersistTrait<Comment>
     */
    use PersistTrait;
