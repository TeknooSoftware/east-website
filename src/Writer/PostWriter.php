...
/**
 * Object writer in charge of object `Teknoo\East\Website\Object\Post`.
 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements WriterInterface<Post>
 */
class PostWriter implements WriterInterface
{
    /**
     * @use PersistTrait<Post>
     */
    use PersistTrait;
